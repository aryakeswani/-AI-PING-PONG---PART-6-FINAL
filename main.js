...
function preload() {
  ...
  if (ball.y >= paddle1Y&& ball.y <= paddleHeight){
    text("Press Restart Button to PLay again" , width/2,height/2,height/2+30)
  }


  missed_sound = loadSound("missed.wav");
  sucess_sound = loadSound("ball_touch_paddel.wav");
	setSprites();
	MarioAnimation();
}